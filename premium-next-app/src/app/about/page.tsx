...
function FounderCard() {
    return (
        <div className="relative overflow-hidden rounded-2xl border border-white/8 bg-neutral-900/50 backdrop-blur-sm h-full min-h-[480px] lg:min-h-[560px]">
            ...
            <div
                aria-hidden="true"
                className="pointer-events-none absolute -left-16 -top-16 h-64 w-64 rounded-full bg-violet-900/25 blur-[80px]"
            />
            <div
                aria-hidden="true"
                className="pointer-events-none absolute -bottom-16 -right-16 h-64 w-64 rounded-full bg-indigo-900/20 blur-[80px]"
            />
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-white/5 pt-8">
                    {[
                        ...
                        <div key={stat.label} className="text-center">
                            <span className="block font-mono text-2xl font-bold text-white/80">
                                {stat.value}
                            </span>
                            <span className="mt-1 block text-xs text-zinc-600 uppercase tracking-wider">
                                {stat.label}
                            </span>
                        </div>
                    ))}
    ...
    return (
        <div className="bg-black">
            <div className="relative z-10">
                ...
                <section
                    ref={heroRef}
                    className="relative flex min-h-[55vh] items-center overflow-hidden border-b border-white/5"
                >
                    <div
                        aria-hidden="true"
                        className="pointer-events-none absolute left-1/3 top-1/2 h-[500px] w-[500px] -translate-y-1/2 rounded-full bg-violet-900/18 blur-[120px]"
                    />
                ...
                <section ref={storyRef} className="relative py-24 lg:py-32">
                    <div className="mx-auto max-w-7xl px-6 lg:px-12">
                        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
                            ...
                            >
                                <span className="mb-4 text-xs font-semibold uppercase tracking-widest text-zinc-600">
                                    Our Story
                                </span>
