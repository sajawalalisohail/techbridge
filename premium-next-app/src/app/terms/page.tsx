...
export const metadata: Metadata = {
    ...
    description: "Terms governing use of TechBridge services and platforms.",
};
                ...
                <section className="relative flex min-h-[60vh] items-center overflow-hidden">
                    ...
                    <div className="relative z-10 mx-auto max-w-3xl px-6 py-32 lg:px-12">
                        ...
                        <p className="mt-8 text-base leading-relaxed text-zinc-400 lg:text-lg">
                            This page is under construction. Our complete terms of service
                            governing the use of TechBridge services and platforms will be
