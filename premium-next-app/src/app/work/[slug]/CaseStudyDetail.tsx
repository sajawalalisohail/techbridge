                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                {study.liveUrl && (
                                    <a
                                        ...
                                        className="group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-6 py-4 text-sm font-medium text-white transition-all duration-300 hover:border-violet-500/40 hover:bg-violet-950/30"
                                    >
                                        View Live Site
                                        <ArrowUpRight
                                            size={14}
