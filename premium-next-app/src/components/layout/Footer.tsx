...
const SERVICES_LINKS = [
    ...
    { label: "24-Hour Websites", href: "/services" },
];
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-12">
                ...
                <div className="grid grid-cols-2 gap-12 md:grid-cols-4 lg:gap-16">
                    ...
                    <div>
                        ...
                        <Link
                            href="/contact"
                            className="group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-5 py-2.5 text-sm font-medium text-white transition-all duration-300 hover:border-violet-500/40 hover:bg-violet-950/30 hover:shadow-[0_0_20px_rgba(109,40,217,0.2)]"
                        >
                            Book a Call
                            <svg
